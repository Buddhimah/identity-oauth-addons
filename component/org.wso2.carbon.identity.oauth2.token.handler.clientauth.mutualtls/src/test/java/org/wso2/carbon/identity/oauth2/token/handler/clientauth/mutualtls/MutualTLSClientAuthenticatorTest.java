...
public class MutualTLSClientAuthenticatorTest extends PowerMockTestCase {
    ...
    private static String TEST_JSON_WITH_X5T ="{\n" +
            ...
            "    \"kty\" : \"RSA\",\n" +
            "    \"n\" : \"xd_gJKFwSqB0XbB8mq15S7Sv5WnZyQFHjFZBDLEpUHJV5UaGIVl60iEHUAupKqq4dT8ctprJRZPvOkYZyUoYLPg9n1pEp_CVYeYhV71gLUmCmrUe52LP-TERvjk7gF16c8UCVT7G4xtzWw1hJtc1eDB5v6NsxpWRr5j2F6VdRvN__wuRRglmN1Gdw039ZvEGdCt-SEnVn4dpVuQ\",\n" +
            "    \"use\" : \"tls\",\n" +
            "    \"x5t\" : \"RjM3REY1MEVFMUQ2MTZDNzIyMTYzQTk5MTI5MjNCQ0YyMkM2MkU1MQ\",\n" +
            "    \"x5u\" : \"https://keystore.abc.org.lk/0015800001HQQrZAAX/RjM3REY1MEVFMUQ2MTZDNzIyMTYzQTk5MTI5MjNCQ0YyMkM2MkU1MQ.pem\",\n" +
            "    \"x5t#S256\" : \"tpqKoTkfPzQPheMha9zGtEg0srbSTDUc=\"\n" +
            "  }, {\n" +
            "    \"e\" : \"AQAB\",\n" +
            ...
            "    \"x5u\" : \"https://keystore.abc.org.lk/0015800001HQQrZAAX/M2maFm3VYlMBOn3GetVWGXkrKrk.pem\",\n" +
    ...
    private static String TEST_JSON_WITH_X5C ="{\n" +
            ...
            "    \"x5u\" : \"https://keystore.abc.org.lk/0015800001HQQrZAAX/RjM3REY1MEVFMUQ2MTZDNzIyMTYzQTk5MTI5MjNCQ0YyMkM2MkU1MQ.pem\",\n" +
            "    \"x5t#S256\" : \"tp0G-8t-sa-heMha9zGtEg0srbSTDUc=\"\n" +
            "  }, {\n" +
            "    \"e\" : \"AQAB\",\n" +
            "    \"kid\" : \"M2maFm3VYlMBOn3GetVWGXkrKrk\",\n" +
            "    \"kty\" : \"RSA\",\n" +
    ...
    private static String TEST_JSON ="{\n" +
            ...
            "    \"use\" : \"tls\",\n" +
            "    \"x5u\" : \"https://keystore.openbankingtest.org.uk/0015800001HQQrZAAX/uzPTFFKqK6VwzzdbFxmnTlE4ezc.pem\",\n" +
            ...
            "    \"n\" : \"p5KzjtKkBSJRtWAmS5ueHRQ-CCAIVvFZBIPUPCLf_N0RSo95M8gSKRVAuR0trmzoJ_L-wQkysz9Ax93ziIq-mz_0Z65Lc6EtyE9O2PO5ED5fWt8_-g1hFttbORNAH9dJF0fbwdeJclG3rKuJDzLF80rIV88cFY1Iug_kRerjlSD5yQ5bJfNeP-V7XKILo570RR7GThgLwmWNWAWKA-63zmjr1OAI2IDx5R6krlY6dPQ57euwhMS8TWpuo27CHUirKAoBzPywcssPcpfRaT0dNv_83AkxRtsOUMizAWVh8MGhUUe2bHpQdRxKD_0X7U_5V3Y0aPFUikICTW2_Je8jbQ\",\n" +
            "    \"use\" : \"sig\",\n" +
            "    \"x5u\" : \"https://keystore.openbankingtest.org.uk/0015800001HQQrZAAX/CzUe1ecMKykHLhQAATzFBudOj0Y.pem\",\n" +
